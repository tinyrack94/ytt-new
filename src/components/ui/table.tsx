    ...
    >
      <tr
        ...
        className={clsx(
          className,
          href &&
            'dark:focus-within:bg-white/2.5 has-[[data-row-link][data-focus]]:outline-2 has-[[data-row-link][data-focus]]:-outline-offset-2 has-[[data-row-link][data-focus]]:outline-blue-500',
